...
Up-to-date [KernelSU-Next] ( https://github.com/KernelSU-Next/KernelSU-Next) Implementation of [ExtremeKernel](https://github.com/ExtremeXT/990_upstream_v2) for One UI 7
...
```git clone --recurse-submodules https://github.com/Mesazane/990_kernel.git```

3. Build for your device without CCache and with KSU

```./build.sh -m c2s -k y -c n```
